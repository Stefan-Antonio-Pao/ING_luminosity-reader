...
/**
 * App 入口。 起:`onCreate` 第一件事调用 [AppGraph.init],把 [Application]
 ...
 *
 * UI overhaul(2026-05-25):用 [LumiTheme] 取代原私有 `LumiReadTheme`。
 * 当前是骨架版,只按 mode 选 tokens + 套 MaterialTheme,**视觉与改造前完全一致**。
 * will引入 playfulness 动画; ChildTokens 才会落地卡通值。
 */
